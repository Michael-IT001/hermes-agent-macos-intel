...
This repository provides an unofficial community build of Hermes Desktop for Intel Macs (`x86_64`).
...
- Artifact: `Hermes-0.17.0-mac-x64-unofficial-586aae4.zip`
...
```text
2779bc16d73252a323de5a81f2669c4b2384b510ee28da19a0012ba492cd4a7e  Hermes-0.17.0-mac-x64-unofficial-586aae4.zip
```

## Important Notes

- This is not an official Nous Research release.
